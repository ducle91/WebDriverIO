...
/*   it("should move to this 'Plan & Pricing'", () => {
	browser.waitForVisible('body > header > div.hide-for-large-up > nav > div.row.has-bg-white > div > ul > li.toggle-topbar.top-bar--custom__toggle-topbar > a > span', 5000);
	
	browser.moveTo('body > header > div.hide-for-large-up > nav > div.row.has-bg-white > div > ul > li.toggle-topbar.top-bar--custom__toggle-topbar > a > span');
	browser.click('ody > header > div.hide-for-large-up > nav > div.row.has-bg-white > div > ul > li.toggle-topbar.top-bar--custom__toggle-topbar > a > span');
	
	browser.moveTo('#menu-item-4440 > a');
	browser.click('#menu-item-4370 > a');

  }); */
  
/*   it("should get CSS elements", () => {
	browser.pause(1000);
	browser.getCssProperty('body > main > section.section.section--img-bg-internet.is-white.is-centered > div > div', 'cssEle');
  }); */
});